		...
		<div class="app-card-body">
			<div class="table-responsive">
				<table class="table app-table-hover mb-0 text-left">
					...
					<tbody>
						<?php
						$sql = "SELECT p.property_id,p.property_name,p.property_img,p.property_desc,p.property_price, pt.property_type_kh,ps.property_status
									FROM tbl_property p 
						...
						?>
							...
							<input type="hidden" name="page" value="property"/>
								<input type="hidden" name="pId" value="<?=$propertyId?>" />
								<tr>
